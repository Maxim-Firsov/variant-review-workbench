...
class CliTests(unittest.TestCase):
    ...
    def test_build_parser_accepts_custom_report_title(self) -> None:
        parser = build_parser()
    ...
    def test_main_reports_when_input_was_truncated(self) -> None:
        ...
        self.assertIn("processed 1 of 3 available variant(s)", stdout.getvalue())
